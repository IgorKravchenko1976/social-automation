...
Поверни JSON:
{
  ...
  "size_class": "hub|intl|regional|small"
}

ПРО size_class:
- "hub" — великий міжнародний хаб (10M+ пасажирів/рік, наприклад CDG, FRA, JFK)
- "intl" — міжнародний аеропорт середнього розміру (1-10M пасажирів)
- "regional" — регіональний/малий комерційний (<1M пасажирів)
- "small" — малий аеропорт або general aviation
Якщо не маєш певної інформації про пасажиропотік — обери найбільш консервативну
(меншу) категорію. НЕ перебільшуй.
...
Поверни JSON:
{
  ...
  "facts": ["Цікавий факт 1", "Цікавий факт 2"],
  "size_class": "hub|regional|small"
}

ПРО size_class (для вокзалів):
- "hub" — великий вузловий вокзал з 10+ платформами та інтерсіті (Київ-Пасажирський, Lwów Główny)
- "regional" — типовий регіональний вокзал
- "small" — невеликий приміський або сільський вокзал
Якщо не певен — обирай меншу категорію.
