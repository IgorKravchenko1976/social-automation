...
1. НАЙВАЖЛИВІШЕ: координати визначають ТОЧНЕ місце на землі. НІКОЛИ не плутай країни!
   Якщо координати вказують на Кіпр — пиши про Кіпр, НЕ про Ізраїль чи іншу країну.
   Якщо coordinates 34.77, 32.40 — це Пафос, Кіпр, а НЕ Кір'ят-Шмона, Ізраїль!
2. Поле country_code ОБОВ'ЯЗКОВЕ — вкажи ISO код країни де реально знаходиться ця точка.
3. Перевір себе: чи всі згадані місця/новини/історія стосуються САМЕ цієї країни та локації?
4. Якщо не впевнений де саме знаходиться точка — краще поверни порожній summary.
