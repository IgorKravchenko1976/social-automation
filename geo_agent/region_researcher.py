...
Поверни JSON:
{
  ...
  "description": "Розгорнутий опис ~500-700 символів. Структуруй на 2-3 теми: \\u2022 Історія: ключові періоди, події, важливі дати (НЕ просто 'багата історія', а конкретні факти: коли заснований, хто завоював, що визначального). \\u2022 Культура / архітектура / кухня — те, що відрізняє це місце. \\u2022 Природа / клімат / географія — для розуміння де це і коли їхати.",
...
Інші правила:
4. Якщо це Росія, Білорусь, окуповані території України — поверни {"_rejected": true}.
5. Якщо рівень "continent" — описуй континент у цілому (географія,
   культурні регіони, що очікувати від подорожі).
