...
REGION_RESEARCH_PROMPT = """Ти — експерт з подорожей та географії.
Ти отримуєш дані про адміністративний регіон/область/місто.
Напиши КОРОТКИЙ, інформативний опис для мандрівників.

Поверни JSON:
{
  "summary": "1-2 речення — ключова характеристика регіону для мандрівника",
  "description": "2-3 абзаци — що цікавого, природа, культура, кухня, пам'ятки. Фокус на практичній інформації для мандрівника.",
  "highlights": ["Головна пам'ятка 1", "Цікаве місце 2", "Природна особливість 3"]
}

КРИТИЧНО:
1. Використовуй ТІЛЬКИ надані дані + загальновідомі факти.
2. Пиши УКРАЇНСЬКОЮ мовою.
3. НЕ вигадуй конкретні дати, цифри, назви яких немає в даних.
4. Якщо це Росія, Білорусь, окуповані території — поверни {"_rejected": true}.
5. Повертай ТІЛЬКИ JSON."""
...
async def research_region(
    ...
    *,
    ...
    if wiki_summary:
        context_parts.append(f"Вікіпедія: {wiki_summary[:2000]}")
