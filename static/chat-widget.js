(function () {
  ...
  style.textContent = [
    ...
    "#imin-chat-fab button,#imin-chat-fab a{width:56px;height:56px;border-radius:50%;border:none;cursor:pointer;box-shadow:0 4px 16px rgba(0,0,0,.3);display:flex;align-items:center;justify-content:center;transition:transform .2s,box-shadow .2s}",
    "#imin-chat-fab button:hover,#imin-chat-fab a:hover{transform:scale(1.08);box-shadow:0 6px 24px rgba(0,0,0,.4)}",
    "#imin-btn-tg{background:#2AABEE}",
    "#imin-btn-chat{background:linear-gradient(135deg,#6ee7b7,#3b82f6)}",

    "#imin-chat-window{position:fixed;bottom:92px;right:24px;width:380px;max-width:calc(100vw - 32px);height:520px;max-height:calc(100vh - 120px);background:#1a1a2e;border-radius:16px;box-shadow:0 8px 40px rgba(0,0,0,.5);z-index:100000;display:none;flex-direction:column;overflow:hidden;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif}",
    ...
    "#imin-chat-input input{flex:1;background:#262640;border:1px solid rgba(255,255,255,.08);border-radius:24px;padding:10px 16px;color:#e2e8f0;font-size:16px;outline:none;transition:border-color .2s;-webkit-appearance:none}",
    "#imin-chat-input input:focus{border-color:rgba(110,231,183,.4)}",
    "#imin-chat-input input::placeholder{color:#64748b}",
    "#imin-chat-input button{width:44px;height:44px;border-radius:50%;border:none;background:linear-gradient(135deg,#6ee7b7,#3b82f6);color:#fff;cursor:pointer;display:flex;align-items:center;justify-content:center;flex-shrink:0;transition:opacity .2s}",
    ...
    "  #imin-chat-messages{padding:12px}",
    "  .imin-msg{max-width:88%;font-size:15px}",
    "  #imin-chat-input{padding:10px 12px;padding-bottom:calc(10px + env(safe-area-inset-bottom,0px))}",
    "  #imin-chat-input input{padding:12px 16px;font-size:16px}",
    "  #imin-chat-input button{width:46px;height:46px}",
    "}"
  ].join("\n");
