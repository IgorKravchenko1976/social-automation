...
3. Скоро вийде оновлення 1.0.1 з новими функціями: табло аеропортів (реальні рейси), камери швидкості, покращені ланцюжки подій. Можеш згадувати це як "очікуйте оновлення".
...
- В кінці: ненавʼязливо згадай www.im-in.net або що додаток I'M IN доступний безкоштовно в App Store (вийшов 5 квітня 2026). Скоро оновлення 1.0.1 з табло аеропортів та камерами швидкості.
