...
async def generate_auto_reply(
    ...
    system = (
        ...
        "- На питання 'звідки ця інформація?' — вкажи джерело якщо є в пості, "
        "або скажи що моніторимо туристичні новини з перевірених джерел\n"
        ...
        "- Якщо доречно, завершуй одним із закликів:\n"
        "  • Слідкуйте за оновленнями на нашій сторінці!\n"
        "  • Деталі на сайті www.im-in.net\n"
        "  • Напишіть нам — допоможемо з плануванням подорожі!\n"
