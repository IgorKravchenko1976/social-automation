...
=== ЗАБОРОНЕНІ ТЕРИТОРІЇ (АБСОЛЮТНА ЗАБОРОНА!) ===
НІКОЛИ не згадуй, не рекомендуй, не пиши про:
- КРИМ (Ялта, Севастополь, Сімферополь, Алушта, будь-яке місто Криму) — анексована територія
- ДОНЕЦЬК, ЛУГАНСЬК, МАРІУПОЛЬ — зона бойових дій
- РОСІЯ (Москва, Петербург, Сочі, будь-яке місто Росії) — повна заборона
- БІЛОРУСЬ (Мінськ, будь-яке місто) — повна заборона
Якщо тема пов'язана з цими територіями — ВІДМОВСЯ і напиши про безпечне місце.
...
- КРИМ (Ялта, Севастополь, Сімферополь, Алушта, будь-яке місто Криму) — анексована територія
- ДОНЕЦЬК, ЛУГАНСЬК, МАРІУПОЛЬ — зона бойових дій
- Будь-які окуповані території України
- РОСІЯ (Москва, Петербург, Сочі, будь-яке місто) — повна заборона
- БІЛОРУСЬ (Мінськ, будь-яке місто) — повна заборона
...
=== ЗАБОРОНЕНІ ТЕРИТОРІЇ (АБСОЛЮТНА ЗАБОРОНА!) ===
НІКОЛИ не згадуй: Крим (Ялта, Севастополь та ін.), Донецьк, Луганськ, Маріуполь,
будь-які окуповані території, Росія (всі міста), Білорусь.
Якщо тема пов'язана з цими територіями — заміни на безпечне місце.
...
async def generate_unique_topic(
    ...
    *,
    ...
    system_msg = (
        ...
        "\n\nЗАБОРОНЕНІ ТЕРИТОРІЇ (АБСОЛЮТНА ЗАБОРОНА!): "
        "НІКОЛИ не пропонуй теми про: Крим (Ялта, Севастополь, Сімферополь, Алушта — "
        "ВСЕ місто Криму), Донецьк, Луганськ, Маріуполь, будь-які окуповані території "
        "України, Росію (Москва, Петербург, Сочі — ВСІ міста Росії), Білорусь. "
        "Ці території окуповані або там йде війна. Заміни на безпечне місце. "
